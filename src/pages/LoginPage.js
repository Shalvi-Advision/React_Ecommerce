          ...
          <div className="max-w-md text-center">
            ...
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-2xl shadow-lg">
                <div className="flex items-center gap-2">
                  <span className="text-3xl font-bold text-emerald-600">D</span>
                  <div className="flex flex-col items-start">
                    <span className="text-xl font-bold text-gray-800 leading-none">Mart</span>
            ...
            <div className="relative">
              <svg viewBox="0 0 400 500" className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* D-Mart Logo on Bag */}
                <text x="268" y="400" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="#10b981">D</text>
                <text x="285" y="400" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="bold" fill="#0d9488">Mart</text>

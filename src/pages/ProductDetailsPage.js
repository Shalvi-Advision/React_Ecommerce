      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <div className="relative">
                ...
                {product.pcode_img ? (
                  <img
                    ...
                    className={`w-full h-64 sm:h-80 lg:h-96 object-contain rounded-lg transition-opacity duration-300 ${
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-4 leading-tight">
            ...
            {/* Description */}
            <div>
              <h3 className="text-sm sm:text-base font-semibold text-gray-700 mb-2">Description</h3>
            ...
            {/* Package Size */}
            <div>
              <h3 className="text-sm sm:text-base font-semibold text-gray-700 mb-2">Package Size</h3>
            ...
            {/* Stock Status */}
            <div>
              <h3 className="text-sm sm:text-base font-semibold text-gray-700 mb-2">Availability</h3>
            ...
            <div className="border-t pt-4 sm:pt-6">
              ...
              <div className="flex items-center space-x-4 mb-4 sm:mb-6">
                ...
                <div className="flex items-center border border-gray-300 rounded-lg">
                  ...
                  <span className="px-4 py-2 text-center min-w-12 text-sm sm:text-base">{quantity}</span>
                  <button
                    onClick={() => handleQuantityChange(1)}
                    className="px-3 py-2 text-gray-600 hover:text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"

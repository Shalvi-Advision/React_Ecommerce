...
const SeasonalCategories = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 py-8 overflow-hidden">
...
`}
          ...
          <div className="flex gap-3 overflow-x-auto flex-1 hide-scrollbar">
            {categories.map((category, index) => (
              ...
              >
                {/* Card */}
                <div className="w-20 h-20 md:w-24 md:h-24 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 flex items-center justify-center mb-3 border border-gray-100">
